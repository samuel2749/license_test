<template lang="pug">
	.home.container(:class="{'text-center': !isMobile}")
		...
		router-link.btn.btn-lg.btn-success(:class="{'btn-block': isMobile}" to="./bulldozer") 推土機 測驗
		router-link.btn.btn-lg.btn-success(:class="{'btn-block': isMobile, 'ml-2': !isMobile}" to="./mkp") MKP 測驗
